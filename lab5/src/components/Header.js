...
const Header = () => {
    ...
    return (
        <div className={`common-header ${isProfilePage ? 'profile-page' : ''}`}>
            <Link to="/">
                <img className="logo" src={ENDPOINTS.STATIC("site-logo.png")} alt="Healthy Life" />
            </Link>

            <div className={`menu-button ${isProfilePage ? 'profile-page-menu' : ''}`} onClick={toggleMenu}>
                <img src={ENDPOINTS.STATIC("menu-button.png")} alt="Menu button" />
                {isMenuOpen && (
                    <div className="menu">
                        {user && (
                            <>
            ...
            {!isProfilePage && (
                <div className="auth-button">
                    {user ? (
                        <Link to="/profile">
                            <img
                                src={user.photoURL || ENDPOINTS.STATIC("default-avatar.png")}
                                alt="User profile"
                        ...
                        <Link to="/auth">
                            <img src={ENDPOINTS.STATIC("auth-button.jpg")} alt="Auth button" />
                        </Link>
                    )}
                </div>
            )}
