                    ...
                    <>
                        <div className="home-center-box-auth">
                            ...
                            <div className="content profile-block-auth">
                                <Link to="/profile">
                                    <img src="/resources/image/home/profile-home.png" alt="Profile"/>
                                    <div className="text">Мій Профіль</div>
                                </Link>
                            </div>
                            <div className="content progress-auth">
                                <Link to="/progress">
                                    <img src="/resources/image/home/progress-home.jpg" alt="Progress"/>
                                    <div className="text">Мій Прогрес</div>
                                </Link>
                            </div>
                            <div className="content exercises-auth">
                                <Link to="/training-programs">
                                    <img src="/resources/image/home/gym-home-auth.jpg" alt="Exercises"/>
                                    <div className="text">Тренування</div>
                                </Link>
                            </div>
                            <div className="content ration-auth">
                                <Link to="/ration">
                                    <img src="/resources/image/home/ration-home.jpg" alt="Ration"/>
                    ...
                    <>
                        <div className="home-center-box-not-auth">
                            ...
                            <div className="content auth">
                                <Link to="/auth">
                                    <img src="/resources/image/auth-button.jpg" alt="Auth"/>
                                    <div className="text">Вхід/Реєстрація</div>
                                </Link>
                            </div>
                            <div className="content exercises-not-auth">
                                <Link to="/training-programs">
                                    <img src="/resources/image/home/gym-home-not-auth.jpg" alt="Exercises"/>
                                    <div className="text">Тренування</div>
                                </Link>
                            </div>
